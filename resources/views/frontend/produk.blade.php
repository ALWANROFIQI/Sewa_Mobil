      ...
      @foreach($cars as $car)
        <div class="col mb-5">
            <div class="card h-100">
              <!-- Sale badge-->
              <div
                class="badge badge-custom {{ $car->status == 'tersedia' ? 'bg-succes' : 'bg-warning' }} text-black position-absolute" 
              ...
              <div class="card-body card-body-custom pt-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">{{ $car->name_mobil }}</h5>
                  <!-- Product price-->
              ...
              <div class="card-footer border-top-0 bg-transparent">
                <div class="text-center">
                  <a class="btn btn-primary mt-auto"
                   href="https://api.whatsapp.com/send?phone=082337576302&text=Saya%20tertarik%20untuk%20menyewa%20mobil%20{{ $car->nama_mobil}} ini%20 segera.%20" >Sewa</a>
                  <a
